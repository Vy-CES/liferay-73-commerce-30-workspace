...
/**
 * Provides the local service interface for KolanotInvoiceLine. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see KolanotInvoiceLineLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface KolanotInvoiceLineLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.kolanot.service.service.impl.KolanotInvoiceLineLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the kolanot invoice line local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link KolanotInvoiceLineLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect KolanotInvoiceLineLocalServiceImpl for overloaded versions of the method. If provided, use these entry points to the API, as the implementation logic may require the additional parameters defined there.
	 * </p>
	 *
	...
	public List<KolanotInvoiceLine> findInvoiceLineByInvoiceId(
