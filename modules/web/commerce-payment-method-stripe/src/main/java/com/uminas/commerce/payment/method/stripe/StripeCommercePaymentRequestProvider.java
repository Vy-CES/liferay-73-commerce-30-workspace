...
public class StripeCommercePaymentRequestProvider
	...
	public CommercePaymentRequest getCommercePaymentRequest(
		...
		if (invoiceId != null) {
			...
			StringBuilder returnUrlBundle = new StringBuilder(returnUrl);
			returnUrlBundle.append(StringPool.AMPERSAND);
			returnUrlBundle.append(
					StripeCommercePaymentMethodConstants.
						KOLANOT_INVOICE_PORTLET_INVOICE_ID);
			returnUrlBundle.append(invoiceId);

			returnUrlBundle.append(StringPool.AMPERSAND);
			returnUrlBundle.append("mvcRenderCommandName=");
			returnUrlBundle.append("viewKolanotCommerceInvoicePaymentConfirmation");

			returnUrl = returnUrlBundle.toString();
		}
